...
export interface LedgerRepository { read(month: string): Promise<Ledger>; initialize(month: string): Promise<void>; addMovement(value: Movement): Promise<void>; saveObligation(value: Obligation, applyFutureAmount?: boolean): Promise<void>; removeMovement(id: string, month: string): Promise<void>; saveExpense(value: DailyExpense): Promise<void>; removeExpense(id: string, month: string): Promise<void> }
